...
const Home = () => {
    ...
    return (
        ...
        >
            <Box className="flex items-center w-full" sx={{ height: '10vh' }}>
                <Header />
            </Box>

            <Box className="relative flex items-center w-full" sx={{ height: isMobile ? '65vh' : '70vh' }}>
            ...
            {isMobile ? (<Box className="flex flex-col w-full" sx={{ height: '30vh' }}>
            ...
            </Box>) : (<Box className="flex flex-col w-full mb-6 sm:flex-row md:flex-row lg:flex-row" sx={{ height: '20vh' }}>
                <Box className="flex items-center justify-around w-full sm:justify-between md:justify-between lg:justify-between sm:w-1/3 md:w-1/3">
                    <Box className="w-0 sm:w-1/12 md:w-1/12 lg:w-1/12"></Box>
                    <WhiteCustomButton label={'Enquire now!'} iconSrc={'images/Vector.svg'} />
                    <WhiteCustomButton label={'Contact Us'} iconSrc={'images/Vector.svg'} />
                </Box>
