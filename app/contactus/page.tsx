        ...
        <Box className="container mx-auto max-w-screen-2xl">
            ...
            <Box
                sx={{
                    ...
                    '& > *:not(:last-child)': {
                        marginBottom: isMobile ? '3rem' : '6rem', // Adjust spacing for mobile
                    },
                    marginBottom: isMobile ? '3rem' : '6rem', // Adjust bottom margin for mobile
                }}
            >

                {isMobile ? <Box className="flex w-full flex-col px-3 items-center gap-y-5">
                    <Box className="flex w-full justify-center">
                        <Box className="flex flex-col w-1/3 gap-y-3">
                            <Box>
                                <Image
                    ...
                    : <Box className="flex w-full px-12 space-x-3">
                ...
                >
                    ...
                    className="relative flex w-full px-14 py-24 gap-x-12 rounded-[20px]"
                    sx={{
                ...
                >
                    ...
                    <Box className="flex w-1/2 ">
                        ...
                        <Box className="flex flex-col w-5/6 justify-center items-center">
                            ...
                            <Typography variant="h5" className="mb-8" color='#283C28' sx={{
                                fontFamily: 'Montserrat',
                                fontSize: {
                ...
                {isMobile ? <Box className="flex w-full flex-col relative items-center justify-center text-white">
                    ...
                    <Box className="absolute z-10 text-center p-8 w-full flex flex-col gap-y-1">
                    ...
                    : <Box className="flex w-full flex-col relative items-center justify-center text-white">
                        <Box className="flex justify-center items-center w-[35%]">
                            <Image
                                src="/images/About/suppliers.png" // Ensure this image is in the public/images folder
                                alt="Background"
                                // layout="fill"
                ...
                {isMobile ? <Box
                    className="relative flex flex-col w-full px-2 py-8 gap-x-12 gap-y-20 rounded-[20px]"
                    sx={{
                ...
                >
                    ...
                    <Box className="flex w-full justify-between gap-x-16">
                        ...
                        <Box className="flex w-2/5 flex-col justify-center gap-4">
                            <Typography
                                variant="h4"
                                color='#283C28'
                    ...
                    <Box className="flex w-full justify-between gap-10">
                        ...
                        <Box className="flex w-1/2 flex-col justify-center gap-4">
                            <Typography
                                variant="h4"
                                className='font-normal'
                                color='#283C28'
                ...
                {isMobile ? <Box><FullCustomDivider /></Box> : <Box className="px-12"><FullCustomDivider /></Box>}

                {isMobile ? <Box className="px-3"><AgriculturalMobileCarousel /></Box> : <Box className="flex w-full px-12 gap-8 ">
                ...
                >
                    <Box className="flex w-3/5 justify-center flex-col">
                ...
                {isMobile ? <StonesMobileCarousel /> : <Box className="flex w-full px-12 gap-8 ">
                    <Box className="flex w-1/4">
                        <Image
                ...
                >
                    <Box className="flex flex-col w-full h-full justify-center">
                        ...
                        >
                            <Box className="flex flex-col w-5/6 pl-12">
                                <Box>
                                    <Typography
                                        variant="h4"
                                        color="white"
                ...
                {isMobile ? <></> : <Box className="px-12"><FullCustomDivider /></Box>}

                {isMobile ? <LivingMobileCarousel /> : <Box className="w-full flex justify-between gap-x-6 px-12">
                    <Box className="w-1/3">
                ...
                >
                    <Box className="flex h-full flex-col w-full justify-between">
                        <Box className="flex flex-col w-full gap-y-5">
                            <Box className="flex flex-col">
                                <Box>
                                    <Typography
                ...
                >
                    ...
                    <Box className="flex flex-col w-1/2 h-full p-6 items-start" sx={{ zIndex: 2 }}>
                        <Box className="flex w-full h-1/2"></Box>
                ...
                {isMobile ? <Box className="flex w-full flex-col lg:flex-row justify-between px-3">
                    ...
                    <CustomDivider />
                </Box> : <Box className="flex w-full flex-col lg:flex-row justify-between px-12">
