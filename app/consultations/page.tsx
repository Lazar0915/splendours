            ...
            >
                ...
                {isMobile ? <Box className="flex w-full flex-col px-3">
                    ...
                    : <Box className="flex w-full flex-col px-12">
                        ...
                        > <span style={{ color: '#DCC5BD' }}>HOME DESERVES </span>
                            THE BRILLIANCE OF
                        </Typography>
                        <Typography
                            variant="h3"
                ...
                </Box> : <Box className="flex w-full flex-col gap-3 px-12">
                ...
                >
                    ...
                    className="relative flex-col w-full px-14 py-24 gap-x-12 rounded-[20px] space-y-8"
                    sx={{
