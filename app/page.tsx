...
const HomePage = () => {
    ...
    return (
        <Box className="container mx-auto space-y-24 max-w-screen-2xl">

            <Home />

            <Splendours_header_level />

            <Box className="px-10 space-y-24">
            ...
            </Box> : <Box className="flex flex-col px-10">
            ...
            >
                ...
                <Box className="flex flex-col w-full px-16 space-y-4">
                    <Box className="flex items-center w-3/5">
                        <Typography
                            className="font-bold"
                            variant="h3"
                            color="#283C28"
                ...
                <Box className="flex w-full px-4">
                    <WallingRangeEmblaCarousel slides={SLIDES} options={OPTIONS} />
                </Box>
            </Box>
                : <Box
                    className="relative flex flex-col w-full px-16 py-20 gap-y-24 rounded-[40px]"
                    sx={{
                ...
                >
                    ...
                    <Box className="flex items-start justify-between w-full">
                        ...
                        <Box className="flex flex-col w-1/4 gap-y-6">
                            <Box>
                                <Typography
                                    variant="h3"
                                    color="#000000"
            ...
            <Box className="space-y-24">
                <Box sx={{ width: '100%', display: 'flex', flexDirection: isMobile ? 'column' : 'row', justifyContent: isMobile ? 'center' : 'space-between', alignItems: isMobile ? 'center' : 'flex-end' }}>
                    ...
                    </Box> : <Box className="flex flex-col justify-start w-1/4 gap-3 ">
                        <Box>
                            <Typography
                                variant="h3"
                                color="#ffffff"
                ...
                {isMobile ? <StairsCarousel images={images} /> : <Box className="w-full flex flex-col aspect-[3.77/1] min-w-1 bg-[#DBC6BC] rounded-[40px] p-8" style={{ marginTop: '270px' }}>
                    ...
                    <Box className="flex justify-between w-full">
                        ...
                        <Box>
                            <GreenCustomButton label={'Try it!'} iconSrc={'images/vector.svg'} />
                        </Box>
                    </Box>
                </Box>}
            ...
            </Box> : <Box className="px-16 space-y-6">
            ...
            >
                <Box className="flex flex-col items-center w-full px-3 space-y-4">
                    <Box className="flex flex-col w-full">
                        <Typography
                            variant="h3"
                            color="#283C28"
                ...
                <Box className="flex flex-col w-full space-y-3 px-3">
                ...
                className="relative flex flex-col w-full px-16 py-20 gap-y-8 rounded-[40px]"
                sx={{
